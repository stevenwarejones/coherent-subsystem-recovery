...
def main():
 ...
 print(f'PASS on the certified adversarial instance at f=9/10: every allowed controller has r <= {alpha} = {float(alpha)}')
 print(f'PASS family consequence: on the corresponding instance at each f in [9/10,1], r <= 1 - ({beta})(1-f)')
